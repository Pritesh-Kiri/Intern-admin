const getProducts = async () => {
  try {
    const results = await fetch(
      "https://internship-portal-73765-default-rtdb.firebaseio.com/products.json"
    );
...
const categoryContainer = document.getElementById("category_category");
